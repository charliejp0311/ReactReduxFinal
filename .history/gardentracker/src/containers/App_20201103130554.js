...
import {GardenContainer} from './gardenbook/GardenbookContainer'
class App extends Component() {
  ...
  render(){
    return (
      <div className="App">
        <Switch>
          <Route exact path='/' component={GardenContainer}/> {/*render={routerProps => <CreateGarden {...routerProps} />} /> {/* Home page what do welcome page shows gardens last event logged to the notes shows plant count shows harvest count */}
