  ...
  render(){
    ...
    return (
      <div className="App">
          ...
          <NavBar />
        <Switch>
          <Route exact path='/' component={()=><GardenbookContainer handleSubmit={this.handleSubmit} handleChange={this.handleChange}/>} /> 
          <Route exact path='/garden' component={()=><GardenContainer handleSubmit={this.handleSubmit} handleChange={this.handleChange}/>}/> 
          <Route exact path='/harvest' component={()=><HarvestContainer />}/>
          <Route exact path='/plants/:id' component={()=><PlantContainer handleSubmit={this.handleSubmit} handleChange={this.handleChange}/>}/>
        </Switch>
      </div>
    );
  };
